        ...
        <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 px-4">
            ...
            <form className="relative w-full max-w-md">
                <div className="bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/80 border rounded-2xl shadow-2xl p-8 space-y-6">
                    ...
                    <FieldGroup>
                        <Field>
                            <FieldLabel htmlFor="username_register" className="text-sm font-medium">
                                Nombre de usuario
                            </FieldLabel>
                            <div className="relative">
                                <Icons.User2 size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                                <Input
                        ...
                        <Field>
                            <FieldLabel htmlFor="name_register" className="text-sm font-medium">
                                Nombre completo
                            </FieldLabel>
                            <div className="relative">
                                <Icons.User2 size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
                        ...
                        <Field>
                            <FieldLabel htmlFor="email_register" className="text-sm font-medium">
                                Correo electrónico
                            </FieldLabel>
                            <div className="relative">
                        ...
                        <Field>
                            <FieldLabel htmlFor="password_register" className="text-sm font-medium">
                                Contraseña
                            </FieldLabel>
                            <div className="relative">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div>
                                <Link to="/login">
                                    <Button variant={"link"} className="cursor-pointer">¿Ya tienes cuenta?</Button>
                                </Link>
                            </div>
                        </div>

                        <Button type="submit" className="w-full h-11 text-base font-medium cursor-pointer">
                            Crear cuenta
                        </Button>
                    </FieldGroup>
