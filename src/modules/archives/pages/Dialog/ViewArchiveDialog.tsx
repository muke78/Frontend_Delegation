...
export const ViewArchiveDialog = ({ open, archiveId, onClose }: ArchiveActionsType) => {
    ...
    const {
        ...
        handlePageChange,
        handleLimitChange,
        clearDuplexParams } = useArchiveDuplex({
            open, archiveId
        })
    return (
        <Dialog
                ...
                <div className="space-y-6">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between">
                            ...
                            <CardAction>
                                {/* aquí luego puedes meter botones */}
                            </CardAction>
                        </CardHeader>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                                ...
                                <div className="col-span-2">
                                    <p className="text-muted-foreground">Ruta de almacenamiento</p>
                    ...
                    <Card>
                                        ...
                                        <TableBody>
                                            {relatedView.length > 0 ? (
                                                relatedView.map((reltd) => (
                                                    <TableRow key={reltd.related_entries_id} className="hover:bg-muted/30">
                                                        ...
                                                        <TableCell>{reltd.event_date.split("T")[0]}</TableCell>
                        ...
                        {paginationViewDuplex && (
                            <div className="flex justify-center">
                                <PagintationApp pagination={paginationViewDuplex} onPageChange={handlePageChange} />
                            </div>
                        )}
                    </Card>
                </div>
