				...
				<DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
					<DialogHeader>
						<DialogTitle className="text-2xl">
							Editar el archivo {archiveName}
						</DialogTitle>
						<DialogDescription>
							Edite la informacion del archivo, los campos se pueden cambiar o
							dejarse asi, solo no deben quedar vacios
						</DialogDescription>
					</DialogHeader>
					...
					<form onSubmit={onmSubmitEdit} className="space-y-6 py-4">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="space-y-2">
								...
								<Select
									value={formEdit.doc_type}
									onValueChange={(value) =>
										setFormEdit((prev) => ({ ...prev, doc_type: value }))
									}
								>
