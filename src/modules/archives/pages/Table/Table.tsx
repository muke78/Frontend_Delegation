						...
						<TableHeader>
							<TableRow>
								...
								{columnVisibility.identifier && (
									<TableHead className="font-semibold min-w-30">
										Identificador
									</TableHead>
								)}
								...
								{columnVisibility.folio && (
									<TableHead className="font-semibold min-w-32.5">
										Folio
									</TableHead>
								)}
								{columnVisibility.name && (
									<TableHead className="font-semibold min-w-50">
										Nombre
									</TableHead>
								)}
								...
								{columnVisibility.creator && (
									<TableHead className="font-semibold min-w-37.5">
										Creado por
									</TableHead>
								)}
								{columnVisibility.actions && (
									<TableHead className="font-semibold text-right min-w-50">
										Acciones
									</TableHead>
								)}
							</TableRow>
									...
									>
										{columnVisibility.id && (
											<TableCell className="font-medium text-muted-foreground">
												{paginationArchive &&
													getRowIndex(paginationArchive, idx)}
											</TableCell>
										)}
										{columnVisibility.identifier && (
										...
										{columnVisibility.path && (
											<TableCell
												className="text-xs text-muted-foreground max-w-50 truncate font-mono"
												title={arch.storage_path}
											>
												{arch.storage_path}
											</TableCell>
										)}
