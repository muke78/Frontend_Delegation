...
export const CreateRelatedDialog = () => {
    ...
    const { formCreate, setFormCreate, openDialog, setOpenDialog, handleSubmitCreate } = useRelatedContext()
                    ...
                    <form onSubmit={onSubmitCreate} className="space-y-6 py-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2 col-span-2">
                                <Label htmlFor="description" className="text-sm font-medium" id="description-by-label">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        <SelectGroup>
                                            ...
                                            {archive.map((arch) => (
                                                <SelectItem key={arch.identifier} value={arch.archives_id}>
                                                    {arch.identifier} - ({arch.name})
                                                </SelectItem>
                                            ))}
                                        </SelectGroup>
                                    </SelectContent>
                            ...
                            <div className="space-y-2 col-span-2">
                                <Label htmlFor="responsible_person" className="text-sm font-medium">
                            ...
                            <div className="space-y-2 col-span-2">
                                <Label htmlFor="responsible_role" className="text-sm font-medium" id="created-by-label">
                                    Persona a cargo
                                </Label>
                                <Select
                                    value={formCreate.responsible_role}
                                    onValueChange={(value) =>
                                        setFormCreate((prev) => ({ ...prev, responsible_role: value }))
                                    }
                                >
                                    <SelectTrigger
                                        id="responsible_role"
