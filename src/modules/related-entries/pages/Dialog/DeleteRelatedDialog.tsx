...
export const DeleteRelatedDialog = ({ open, archiveId, relatedId, relatedDescription, onClose }: RelatedActionsType) => {
        ...
        <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
            ...
            <DialogContent className="w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Al dar clic en aceptar, el registro {relatedDescription} sera eliminado de
                        forma definitiva
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter>
